...
"==============================================================
" 7.3. Rainbow 括号彩色显示（使用默认配置）
"==============================================================
" 注意：g:rainbow_active 已在 0.1 节中设置（必须在插件加载前）
call s:source_if_exists(s:config_root . '/plugins/rainbow.vim')

"==============================================================
" 7.4. 缩进可视化配置（indentLine）
"==============================================================
call s:source_if_exists(s:config_root . '/plugins/indent.vim')

"==============================================================
" 7.5. 自动高亮当前单词（vim-cursorword，无需配置）
"==============================================================

"==============================================================
" 7.6. TODO 搜索功能（Vim 原生）
"==============================================================
call s:source_if_exists(s:config_root . '/plugins/todo.vim')

"==============================================================
" 7.7. ddx.vim 十六进制编辑器配置
"==============================================================
