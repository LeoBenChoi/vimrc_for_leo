...
" 文件位置: ~/.vim/after/plugin/translator.vim
" 说明: 此文件会在所有插件加载后自动执行，用于配置 vim-translator 翻译插件
" 依赖: voldikss/vim-translator
" ============================================================================
...
" 0. Python 解释器设置
" 显式指定使用 'python' 命令（Windows 下手动安装的 Python 通常只有此命令）
" 注意: 虽然插件不支持 g:translator_python_executable 变量，但通过设置
" g:python3_host_prog = 'python'（已在 vimrc.vim 中设置），插件会回退到
" 使用 'python' 命令，从而实现相同的效果。
let g:translator_python_executable = 'python'
