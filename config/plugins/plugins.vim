...
" Plug 'Shougo/ddx-ui-hex'                            " ddx 提供十六进制编辑的用户界面（必需）
" Plug 'Shougo/ddx-analyzer-zip'                      " ddx 分析 ZIP 文件结构（必需）
" Plug 'Shougo/ddx-commands.vim'                      " ddx 为 ddx.vim 提供命令行命令（必需）
...
" Plug 'rootkiter/vim-hexedit'                       " 十六进制编辑器（已禁用）
