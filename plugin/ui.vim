...
" ============================================================================
" 第一板斧：开启真彩色模式（修复绝大多数色彩渲染错误）
" ============================================================================
" 必须在主题设置之前开启，确保颜色计算正确
" Windows Terminal 完美支持真彩色，开启后可以解决大部分串色问题
...
" 主题相关显示设置
" ============================================================================
" 注意：termguicolors 已在主题设置之前开启（见上方）
...
" ============================================================================
" vim-cursorword 插件配置（光标单词高亮）
" ============================================================================
" 增加延迟时间，减少光标移动时的高亮更新频率，避免闪烁
" 默认值为 50ms，增加到 100ms 可以显著减少闪烁
